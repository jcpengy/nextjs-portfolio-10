    ...
    return (
        <>
            ...
            <section id="graphic-design-project">
                <h2>Customer Engineering Enablement Manager (CEEM)</h2><br />
                <div className="two-column-container">
                    ...
                    <div className="column">
                        <div id="section-description"><h4>Technologies</h4>React, Redux, React Spectrum (React implementation of Adobe’s design system), Unified Shell (Adobe’s UI framework for internal apps), HTML/CSS.</div>
                ...
                <div className="two-column-container">
                    <div className="column">
                        ...
                        <ul>
                            ...
                            <li><span id="glossary">package</span>: collection of artifacts representing a customer use case </li>
                        </ul>
                    </div>
                    <div className="column">
                        <h4>Notes</h4>
                ...
                <div id="section-description">
                    <div className="column">
                        <u>Problem #3</u>The ‘Validation Results’ section does not scale to the amount of data in deployment.
                        <span id="space" />
                        <u>Solution</u>Separate each deployment step into its own tab or page.
                        <span id="space" />
                        <u>Thought process</u>Deployment triggers several processes, including the health check, testing as a service, and web hook events. Each process generates a large amount of data that is pertinent to the user. In Version 1, all these steps were consolidated on a single page, requiring users to scroll through it painstakingly to review results. In Version 2, I introduced separate tabs for each step and an overview panel at the top displaying the start date and duration of the process (this was vague since ‘Webhooks’ does not have a definitive end). In the current design, I opted to represent these steps as individual buttons, each providing key information relevant to its process. Clicking on a button reveals the detailed data for that specific step to the user.
                    </div>
                    <div className="two-column-container">
                        <div className="column">
                            <i>Version 1</i>
